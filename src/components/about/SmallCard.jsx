  ...
  return (
      ...
      >
        ...
        <div
          ...
          "
        >
          <div className="flex flex-col bg-gradient-to-r from-[#141414] to-[#1b1b1b] rounded-md p-6 items-center text-white">
          ...
          <div className="flex rounded-md  bg-gradient-to-r from-[#141414] to-[#1b1b1b] p-6 flex-col items-center text-white">
          ...
          <div className="bg-gradient-to-r rounded-md from-[#141414] to-[#1b1b1b] p-6  flex flex-col items-center text-white">
        ...
        >
          <div>
            ...
            <span className="text-violet-700 text-2xl md:text-3xl font-bold block">
              Get Together
            </span>
          </div>
